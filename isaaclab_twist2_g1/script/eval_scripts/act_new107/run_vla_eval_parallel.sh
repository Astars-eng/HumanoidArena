...
DEFAULT_CHECKPOINT="/DATA/disk0/fym/vla/outputs/act_humanoidarena_sonic_20260812_145530/HOI_double_desk/checkpoints/200000/pretrained_model"
...
RESULTS_TAG="${RESULTS_TAG:-HOI_double_desk_act_new107}"
