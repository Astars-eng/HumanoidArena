...
def main() -> int:
    parser = argparse.ArgumentParser(description="Non-parallel Stream 29D DFS action evaluation suite")
    ...
    parser.add_argument(
        "--sonic_raw107_body_source",
        type=str,
        default=os.environ.get("SONIC_RAW107_BODY_SOURCE", "direct_raw"),
    ...
    parser.add_argument(
        "--server_disable_action_delta_refiner",
        action="store_true",
        default=False,
    ...
    try:
        for model_path in args.model_paths:
            ...
            model_label = _sanitize_label(model_label_for_task_checkpoint(args.task, resolved_model_path))
