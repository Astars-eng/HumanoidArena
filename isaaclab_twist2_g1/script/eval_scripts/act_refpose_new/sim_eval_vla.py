...
# This evaluator owns the raw64 observation assembly in act_refpose_alignment.
# Keep the shared provider on its 40-D semantic action route regardless of
# shell variables left by raw95/raw107 evaluations.
os.environ["SONIC_VLA_ACTION_FORMAT"] = "semantic_v3"
os.environ["SONIC_VLA_STATE_FORMAT"] = "rotlocal_v3"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        default=5,
        help=(
            "Execute this prefix of each predicted chunk before replanning "
            "(default 5 = 0.1 s closed-loop interval at 50 Hz)."
        ),
    )
    parser.add_argument(
