...
DEFAULT_CHECKPOINTS=(
  "/DATA/disk0/fym/vla/outputs/stream_humanoidarena_lerobot/HOI_double_desk_float32_20260812_151035/checkpoints/200000"
)
...
for checkpoint in "${CHECKPOINTS[@]}"; do
  if [[ ! -d "${checkpoint}" ]]; then
    echo "[stream_new107] checkpoint not found: ${checkpoint}" >&2
    exit 2
  fi
