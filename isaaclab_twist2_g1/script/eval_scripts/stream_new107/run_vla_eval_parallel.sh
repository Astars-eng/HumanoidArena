...
DEFAULT_CHECKPOINT="/DATA/disk0/fym/vla/outputs/stream_humanoidarena_lerobot/HOI_double_desk_float32_20260812_151035/checkpoints/200000"
...
RESULTS_TAG="${RESULTS_TAG:-HOI_double_desk_stream_new107}"
