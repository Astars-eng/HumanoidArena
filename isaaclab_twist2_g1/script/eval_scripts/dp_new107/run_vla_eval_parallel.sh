...
# The Diffusion policy was trained with lerobot_new. Let runtime path discovery
...
DEFAULT_CHECKPOINT="/DATA/disk0/fym/vla/outputs/diffusion_humanoidarena_sonic_20260812_145643/HOI_double_desk/checkpoints/200000/pretrained_model"
...
RESULTS_TAG="${RESULTS_TAG:-HOI_double_desk_dp_new107}"
...
for model_path in "${MODEL_PATHS[@]}"; do
  "${SERVER_PYTHON}" "${RUN_SCRIPT_DIR}/dp107_contract.py" "${model_path}"
done
